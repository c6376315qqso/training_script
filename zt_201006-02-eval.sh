...
#block(name=zt_201006-02-eval01, threads=10, memory=100000, subtasks=1, gpu=true, hours=200)
   TASK_NAME=zt_201006-02-eval01
   ...
   --evaluate \
   --use_dense_model \
   --checkpoint_file ckpts/zt_201006-02/Epoch240.pth 
#   --all_to_train  
#   --use_elastic \
#   --simple_train	\
